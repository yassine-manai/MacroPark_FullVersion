...
from auth.Users.forget import Send_Email
...
tags_metadata = [
    ...
    {
        "name": "Reset",
        "description": "Reset Mobile APP user password",
    },
]

app = FastAPI(
    title="Scheidt & Bachmann - Macro Park - Parking Managment System ",
...
app.include_router(ChangePassword)
